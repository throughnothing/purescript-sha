...
main = do
  ...
  assert $ do
    ...
    hash256Empty == "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"

  -- ArrayBuffer
  assert $ do
    let hash512Empty = shaHex SHA_512 $ fromString ""
    hash512Empty == "cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce47d0d13c5d85f2b0ff8318d2877eec2f63b931bd47417a81a538327af927da3e"
  ...
  assert $ do
    ...
    shaHmac256Test2 == "5bdcc146bf60754e6a042426089575c75a003f089d2739839dec58b964ec3843"

  -- Uint8Array
  assert $ do
    let shaHmac512Test2 = shaHmacHex SHA_512 (encodeUtf8 key) (encodeUtf8 dat)
    shaHmac512Test2 == "164b7a7bfcf819e2e395fbe73b56e0a387bd64222e831fd610270cd7ea2505549758bf75c05a994a6d034f65f8f0e6fdcaeab1a34d4a6b4b636e070a38bce737"

  -- DataView
  assert $ do
    let shaHmac224Test2 = shaHmacHex SHA_224 ((dataView <<< encodeUtf8) key) ((dataView <<< encodeUtf8) dat)
    shaHmac224Test2 == "a30e01098bc6dbbf45690f3a7e9e6d0f8bbea2a39e6148008fd05e44"
